...
class EadyInstallWidget extends StatefulWidget {
  const EadyInstallWidget({super.key});

  @override
  State<EadyInstallWidget> createState() => _EadyInstallWidgetState();
}

class _EadyInstallWidgetState extends State<EadyInstallWidget> {
  String _cancelTag = "";
  String _apkFilePath = "";
          ...
          child: Column(
            ...
            children: [
              ...
              _buildButton('打开应用市场', () {
                ...
                //   print("执行---打开应用市场");
                // });
                EasyDebounce.debounce('debouncer2', const Duration(seconds: 2),
                    () {
                  EasyLoading.showToast("执行---打开应用市场");
                  print("执行---打开应用市场");
                });
              ...
              _buildButton('打开设置详情页', () async {
                ...
                print(
                    "_lastTarget: $_lastTarget, target: $target, ===: ${_lastTarget == target}");
                _lastTarget = target;

                EasyDebounce.debounce(
                    'debouncer2', const Duration(seconds: 2), target);
